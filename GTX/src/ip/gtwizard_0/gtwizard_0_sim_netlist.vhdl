...
--               c:/Users/franc/CSUN_senior_design/CSUN_ISOC/GTX/src/ip/gtwizard_0/gtwizard_0_sim_netlist.vhdl
-- Design      : gtwizard_0
...
architecture STRUCTURE of gtwizard_0_sync_block_3 is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_16\ : label is "soft_lutpair0";
...
\FSM_sequential_rx_state[3]_i_16\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000020"
    )
        port map (
...
architecture STRUCTURE of gtwizard_0_RX_STARTUP_FSM is
  ...
  signal time_out_adapt_i_8_n_0 : STD_LOGIC;
  signal time_out_adapt_i_9_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[0]_i_2\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_12\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_13\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_15\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \FSM_sequential_rx_state[3]_i_9\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of gtrxreset_i_i_1 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \init_wait_count[7]_i_3__0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \init_wait_count[7]_i_4__0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \mmcm_lock_count[0]_i_1__0\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \mmcm_lock_count[7]_i_4__0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of mmcm_reset_i_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \reset_time_out_i_2__0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \reset_time_out_i_3__0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of run_phase_alignment_int_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of rx_fsm_reset_done_int_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of rx_fsm_reset_done_int_i_5 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of time_out_100us_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of time_out_1us_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of time_out_2ms_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of time_out_2ms_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \time_out_counter[0]_i_3__0\ : label is "soft_lutpair6";
...
\FSM_sequential_rx_state[3]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\mmcm_lock_count[7]_i_3__0\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => mmcm_lock_count_reg(3),
      I3 => \mmcm_lock_count[7]_i_4__0_n_0\,
      I4 => mmcm_lock_count_reg(4),
      I5 => mmcm_lock_count_reg(6),
      O => \p_0_in__0\(7)
    );
...
sync_RXRESETDONE: entity work.gtwizard_0_sync_block_2
     port map (
      data_out => rxresetdone_s2,
      gt0_rxresetdone_out => gt0_rxresetdone_out,
      sysclk_in => sysclk_in
    );
sync_data_valid: entity work.gtwizard_0_sync_block_3
     port map (
      D(2) => \rx_state__0\(3),
      ...
      \FSM_sequential_rx_state_reg[0]_3\ => \wait_time_cnt[0]_i_1__0_n_0\,
      \FSM_sequential_rx_state_reg[0]_4\ => \FSM_sequential_rx_state[3]_i_13_n_0\,
      \FSM_sequential_rx_state_reg[0]_5\ => \FSM_sequential_rx_state[3]_i_14_n_0\,
      \FSM_sequential_rx_state_reg[0]_6\ => \FSM_sequential_rx_state[3]_i_15_n_0\,
      \FSM_sequential_rx_state_reg[0]_7\ => \FSM_sequential_rx_state[0]_i_2_n_0\,
      \FSM_sequential_rx_state_reg[0]_8\ => \FSM_sequential_rx_state[0]_i_3_n_0\,
      ...
      reset_time_out_reg_3 => \reset_time_out_i_3__0_n_0\,
...
sync_mmcm_lock_reclocked: entity work.gtwizard_0_sync_block_4
     port map (
...
sync_qplllock: entity work.gtwizard_0_sync_block_5
     port map (
...
sync_run_phase_alignment_int: entity work.gtwizard_0_sync_block_6
     port map (
      data_in => run_phase_alignment_int_reg_n_0,
      data_out => run_phase_alignment_int_s2,
      gt0_rxusrclk_in => gt0_rxusrclk_in
    );
sync_rx_fsm_reset_done_int: entity work.gtwizard_0_sync_block_7
     port map (
      data_out => rx_fsm_reset_done_int_s2,
      gt0_rx_fsm_reset_done_out => \^gt0_rx_fsm_reset_done_out\,
      gt0_rxusrclk_in => gt0_rxusrclk_in
    );
sync_time_out_wait_bypass: entity work.gtwizard_0_sync_block_8
     port map (
...
time_out_adapt_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFEFF"
    )
        port map (
...
time_out_adapt_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000080"
    )
        port map (
...
time_out_adapt_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFB"
    )
        port map (
...
time_out_adapt_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEFFF"
    )
        port map (
...
time_out_adapt_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
time_out_adapt_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
time_out_adapt_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
time_out_adapt_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
\wait_time_cnt[0]_i_2__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFD"
    )
        port map (
...
\wait_time_cnt[0]_i_4__0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\wait_time_cnt[0]_i_5__0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\wait_time_cnt_reg[0]_i_3__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \wait_time_cnt[0]_i_4__0_n_0\,
      S(2) => \wait_time_cnt[0]_i_5__0_n_0\,
      S(1) => \wait_time_cnt[0]_i_6__0_n_0\,
      S(0) => \wait_time_cnt[0]_i_7__0_n_0\
    );
...
architecture STRUCTURE of gtwizard_0_TX_STARTUP_FSM is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[2]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[3]_i_11\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[3]_i_12\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[3]_i_13\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[3]_i_5\ : label is "soft_lutpair17";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of QPLL_RESET_i_2 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of gttxreset_i_i_1 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \init_wait_count[1]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \init_wait_count[2]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \init_wait_count[3]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \init_wait_count[4]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \init_wait_count[7]_i_3\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \init_wait_count[7]_i_4\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \mmcm_lock_count[0]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \mmcm_lock_count[1]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \mmcm_lock_count[2]_i_1\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \mmcm_lock_count[7]_i_4\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \time_out_2ms_i_2__0\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of time_out_2ms_i_3 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of time_out_500us_i_2 : label is "soft_lutpair19";
  attribute ADDER_THRESHOLD : integer;
  ...
  attribute SOFT_HLUTNM of \time_tlock_max_i_3__0\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \time_tlock_max_i_4__0\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \time_tlock_max_i_5__0\ : label is "soft_lutpair19";
...
sync_TXRESETDONE: entity work.gtwizard_0_sync_block
     port map (
      data_out => txresetdone_s2,
      gt0_txresetdone_out => gt0_txresetdone_out,
      sysclk_in => sysclk_in
    );
sync_mmcm_lock_reclocked: entity work.gtwizard_0_sync_block_0
     port map (
      SR(0) => sync_mmcm_lock_reclocked_n_0,
      data_out => mmcm_lock_i,
...
sync_qplllock: entity work.gtwizard_0_sync_block_1
     port map (
      ...
      \FSM_sequential_tx_state_reg[1]\ => sync_qplllock_n_1,
...
\wait_time_cnt[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFFFF"
    )
        port map (
      ...
      I2 => wait_time_cnt_reg(0),
      I3 => wait_time_cnt_reg(3),
      I4 => \FSM_sequential_tx_state[3]_i_3_n_0\,
      O => sel
    );
...
entity gtwizard_0_init is
  ...
  attribute RX_CDRLOCK_TIME of gtwizard_0_init : entity is 100000;
  ...
  attribute WAIT_TIME_CDRLOCK of gtwizard_0_init : entity is 6250;
end gtwizard_0_init;
...
architecture STRUCTURE of gtwizard_0_init is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \gt0_rx_cdrlock_counter[0]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \gt0_rx_cdrlock_counter[30]_i_1\ : label is "soft_lutpair30";
  attribute ADDER_THRESHOLD : integer;
...
entity gtwizard_0 is
  ...
  attribute X_CORE_INFO of gtwizard_0 : entity is "gtwizard_0,gtwizard_v3_6_15,{protocol_file=Start_from_scratch}";
end gtwizard_0;
...
architecture STRUCTURE of gtwizard_0 is
  ...
  attribute RX_CDRLOCK_TIME : integer;
  attribute RX_CDRLOCK_TIME of inst : label is 100000;
  attribute STABLE_CLOCK_PERIOD : integer;
  attribute STABLE_CLOCK_PERIOD of inst : label is 16;
  attribute WAIT_TIME_CDRLOCK : integer;
  attribute WAIT_TIME_CDRLOCK of inst : label is 6250;
begin
