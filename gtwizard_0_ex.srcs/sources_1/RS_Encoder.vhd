-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\commrshdl\RS_Encoder.vhd
...
-- 
-- Module: RS_Encoder
-- Source Path: commrshdl/RS Encoder
-- Hierarchy Level: 0
-- Model version: 9.5
-- 
-- -------------------------------------------------------------
...
BEGIN
  ...
  startOut <= Integer_Input_RS_Encoder_HDL_Optimized_out2;

  endOut <= Integer_Input_RS_Encoder_HDL_Optimized_out3;

  validOut <= Integer_Input_RS_Encoder_HDL_Optimized_out4;

  ce_out <= clk_enable;

  dataOut <= Integer_Input_RS_Encoder_HDL_Optimized_out1;
